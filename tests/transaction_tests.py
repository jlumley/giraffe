...
class TestTransactionEndpoints(unittest.TestCase):
    def setup(self, num_categories=1, num_payees=1, num_accounts=1):
        ...
        return {"categories": categories, "accounts": accounts, "payees": payees}
    ...
    def test_create_transaction_fail(self):
        ...
        transactions = [
            ...
            },
            {
                ...
                "account_id": 99999,
                "cleared": True,
                "categories": [{"category_id": 1, "amount": 45}],
            },
            {
                "amount": 1867,
                "date": get_current_date(),
...
def create_transaction(transaction_data):
    ...
    """
    resp = requests.post(f"{BASE_URL}/create", json=transaction_data)
    return resp
...
def update_transaction(transaction_id, transaction_data):
    ...
    Update Transaction
    """
    resp = requests.put(f"{BASE_URL}/update/{transaction_id}", json=transaction_data)
    return resp
...
def delete_transaction(transaction_id):
    ...
    Delete Transaction
    """
    resp = requests.delete(f"{BASE_URL}/delete/{transaction_id}")
    return resp
