...
def test_assigning_money_to_category(test_client):
    ...
    test_client.put(f"/category/assign/{category_id}", json=dict(amount=5000, date="2022-01-01"))
    test_client.put(f"/category/assign/{category_id}", json=dict(amount=5000, date="2022-02-01"))
...
def test_unassigning_money_to_category(test_client):
    ...
    test_client.put(f"/category/assign/{category_id}", json=dict(amount=5000, date="2022-01-01"))
    test_client.put(f"/category/unassign/{category_id}", json=dict(amount=1000, date="2022-01-01"))
